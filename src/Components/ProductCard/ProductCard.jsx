...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="product-cart border h-60 p-4 mb-4 flex items-center bg-gray-100 dark:bg-slate-900 shadow-lg rounded-lg">
      ...
      <div className="product-details flex-1">
        ...
        <p className="text-gray-600 dark:text-white mb-2">{brandName}</p>
        <p className="text-gray-600 dark:text-white mb-2">{type}</p>
        <p className="text-green-600 text-lg font-semibold mb-2">${price.toFixed(2)}</p>
        <p className="text-gray-600 dark:text-white mb-2">Rating: {rating}</p>
